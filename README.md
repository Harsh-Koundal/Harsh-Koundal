...
**Software Development Engineer (SDE-I)** with experience in **production-grade backend systems, full-stack web applications, and Linux-based environments**.  
...
**Concepts:** Component Architecture, State Management, Responsive UI, Performance Optimization

---

### Backend & Database
![NodeJS](https://img.shields.io/badge/Node.js-0D1117?style=for-the-badge&logo=node.js&logoColor=41b35f)
...
**Concepts:** API Design, Authentication (JWT), Validation, Error Handling, Database Schema Design, Query Optimization
...
**Concepts:** VPS Environments, Production Deployment, Repository Management, PR Reviews, Release Stability

---

## Engineering Focus  

- Backend system design and API workflows  
- Performance optimization and scalability  
- Clean, maintainable, production-ready code  
- Linux-based deployment environments  
- Incremental releases and system reliability  
...
<a href="https://github.com/harsh-koundal?tab=followers">
  <img src="https://img.shields.io/github/followers/harsh-koundal?style=for-the-badge&label=Followers&logo=github&color=white"/>
</a>
